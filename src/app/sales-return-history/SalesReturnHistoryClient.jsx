      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 py-4 sm:py-8">
          <div className="rounded-lg bg-amber-50 border border-amber-200 px-4 py-3 text-amber-800 text-sm">
            No customer selected. Please open this page from a customer
            dashboard.
          </div>
          <Link
            href="/new-order"
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-4 sm:py-8">
        ...
        <div className="mb-6">
          <Link
            href={
              partyCode
                ? `/customer-dashboard?party_code=${encodeURIComponent(
                    partyCode,
                  )}`
                : "/customer-dashboard"
            }
        ...
        {error && (
          <div className="rounded-lg bg-red-50 border border-red-200 px-4 py-3 text-red-700 text-sm mb-4">
            ...
            {error === "Session expired. Please log in again." && (
              <Link
                href="/"
                className="inline-block mt-2 font-medium text-red-800 hover:underline"
              >
                Log in again →
              </Link>
            )}
...
export default SalesReturnHistoryClient;
